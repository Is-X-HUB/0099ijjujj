...
ImageButton.Image = "http://www.roblox.com/asset/?id=19001298972"
ImageButton.MouseButton1Down:connect(function()
game.CoreGui:FindFirstChild("Q HUB").Enabled = not game.CoreGui:FindFirstChild("Q HUB").Enabled
end)
...
do
local zasd = game.CoreGui:FindFirstChild("UIHUB")
local zsea = game.CoreGui:FindFirstChild("Q HUB")
if zasd and zsea then
zasd:Destroy()
zsea:Destroy()
end
end
...
function library:Window(text,text2,text3,logo,keybind)
	...
	Hub.Text = text2
	Hub.TextColor3 = Color3.fromRGB(255, 25, 25)
	Hub.TextSize = 17.000
	...
	Ver.Text = text3
	Ver.TextColor3 = Color3.fromRGB(255, 25, 25)
	Ver.TextSize = 15.000
...
_G.Color = Color3.fromRGB(255, 25, 25)
...
--Key
wait(0.1)
AlchemyNotify("Thanks for using Queue Hub!",5)
wait(0.1)
AlchemyNotify("Admin Script",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>Queue Hub<Color=/>"):Display()
wait(0.5)
Notification.new("<Color=Yellow>Create By Queue Hub<Color=/>"):Display()
wait(1)
repeat
    wait()
...
local HomePage = a:Tab("Home",[[16062922985]])
